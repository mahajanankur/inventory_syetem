$(document).ready(function() {
	...
	$('#createClientPopUpForm').bootstrapValidator({
		framework : 'bootstrap',
		feedbackIcons : {
	...
	// validations for update product popup form.
	$('#updateClientPopUpForm').bootstrapValidator({
		framework : 'bootstrap',
		feedbackIcons : {
			valid : 'glyphicon glyphicon-ok',
			invalid : 'glyphicon glyphicon-remove',
	...
	// tool tip for address field on create client pop up.
	$('#address').tooltip({
		placement : "top",
		trigger : "focus"
	});

	// tool tip for address field on update client pop up.
	$('#uAddress').tooltip({
		placement : "top",
		trigger : "focus"
	});
